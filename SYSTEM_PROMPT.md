...
12. `lei-15211-2025-integra.md` — texto da lei, para consulta pontual.
...
Se a ferramenta permitir memória ou arquivos persistentes, mantenha um `memoria-copy.md` a partir do template do repositório: produto e avatar, **fatos verificados com origem e data** (`[FORNECIDO]` pode ser afirmado na copy; `[PRESUMIDO]` continua sendo placeholder), voz da marca e resultados de teste. Leia antes de escrever, atualize depois de entregar.
